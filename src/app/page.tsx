            ...
            <section className="flex flex-col items-start gap-8 md:flex-row-reverse md:items-center md:justify-between">
              ...
              <div className="flex max-w-[320px] flex-col sm:max-w-full">
                ...
                <section className="mt-6 flex flex-wrap items-center gap-4">
                  <Link target="_blank" href={DATA.resume.url}>
                    ...
                    <ul className="ml-10 border-l">
                      {DATA.workExperiences.map((work) => (
                        <li key={work.id} className="relative ml-10 py-4">
                          <Link target="_blank" className="absolute -left-16 top-4 flex items-center justify-center rounded-full bg-white" href={work.website}>
                            <span className="relative flex shrink-0 overflow-hidden rounded-full size-12 border">
                              <Image className="aspect-square h-full w-full bg-background object-contain" alt={work.company} src={work.logo} fill/>
                            </span>
                          </Link>
                    ...
                    <ul className="ml-10 border-l">
                      {DATA.education.map((edu) => (
                        <li key={edu.id} className="relative ml-10 py-4">
                          <Link target="_blank" className="absolute -left-16 top-4 flex items-center justify-center rounded-full bg-white" href={edu.website}>
                            <span className="relative flex shrink-0 overflow-hidden rounded-full size-12 border">
                              <Image className="aspect-square h-full w-full bg-background object-contain" alt={edu.institution} src={edu.logo} fill/>
                            </span>
                          </Link>
                          <div className="flex flex-1 flex-col justify-start gap-1">
                            <time className="text-xs text-muted-foreground">
